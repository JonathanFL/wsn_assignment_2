...
#include <math.h>
#include "../../contiki-ng/os/contiki.h"
#include "../../contiki-ng/os/dev/button-sensor.h"
#include "../../contiki-ng/os/dev/leds.h"
#include "../../contiki-ng/os/sys/log.h"
#include "../../contiki-ng/os/sys/clock.h"
#include "../../contiki-ng/os/sys/energest.h"
#define _N 256
#define _M 75
#define IDLE_MODE_EC 26.1
#define ulong_t unsigned long
void dct();
void print_array(const double *m);
void print_double(double F);
unsigned long to_minutes(uint64_t time);
...
static double transformed_signal[_N];
static const double divider_constant = M_PI/_N;
...
void dct()
{
  ...
  for (k = 0; k < _N; k++)
  {
    ...
    for (n = 0; n < _N; n++)
    {
      transformed_signal[k] += ecg_signal[n]*cos(divider_constant*(n+0.5)*k);
    }
  }
}

ulong_t to_minutes(ulong_t time)
{
  return time/60;
}

ulong_t energy_consumption(ulong_t execution_time)
{
  return execution_time*IDLE_MODE_EC;
}