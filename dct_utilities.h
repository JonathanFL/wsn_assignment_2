...
static const double divider_constant = MY_PI/_N;// this will only change depending on our _N
...
unsigned long energy_consumption(unsigned long execution_time)
{
  return (execution_time*IDLE_MODE_EC)/1000;
}